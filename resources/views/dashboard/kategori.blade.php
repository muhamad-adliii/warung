...
@section('content')
    <div class="wrapper-kategori p-6">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                                            <div class="flex items-center gap-2 ">
                                                <button data-modal-target="editBarangModal{{ $item->id }}" class=" cursor-pointer">
                                                ...
                                                <button data-modal-target="hapusBarangModal{{ $$item->id }}" class="cursor-pointer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                        stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        @include('partials.kategori.tambah')
        @include('partials.kategori.edit')
        @include('partials.kategori.hapus')
    </div>
@endsection