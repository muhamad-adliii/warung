...
<nav class="navbar py-5 px-9 bg-[#ffffff] flex justify-between items-center border-b border-gray-400">
    ...
    <div class="search flex items-center">
        ...
        <!-- search -->
        <div class="pl-5 hidden md:flex">
            <input type="text" name="search" placeholder="Search...."
                class="pl-5 py-1 relative rounded-2xl outline-none border w-64">
        </div>
        <div class="search-icon absolute translate-x-66 hidden md:flex">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width={1.5}
    ...
    <div class="component gap-5 flex">
        <!-- notif -->
        <div class="notif-icon hidden md:flex">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <!-- profile -->
        <div class="relative">
            <div id="profileBtn" class="person-icon flex items-center gap-2 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-7">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                </svg>
                <p class="capitalize hidden md:flex">john doe</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
