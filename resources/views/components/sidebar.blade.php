...
<div class="flex flex-col capitalize gap-10 justify-between">
        ...
        <ul class="space-y-2 mt-12">
            ...
            <li>
                <a href="#"
                    ...
                    <span class="text-lg">kategori barang</span>
                </a>
            </li>
            <li>
                <a href="#"
                    ...
                    <span class="text-lg">data barang</span>
                </a>
            </li>
            ...
            <li>
                <a href="#"
                    ...
                    <span class="text-lg">barang masuk</span>
                </a>
            </li>
            <li>
                <a href="#"
            ...
            <li>
                <a href="#"
                    ...
                    <span class="text-lg">stock log</span>
                </a>
            </li>
        </ul>
    </nav>
    <div class="p-4">
        <a href="#"
            class="flex items-center gap-3 font-medium px-2 py-2 rounded-lg hover:bg-gray-200 transition duration-200 mt-20">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round"
